...
def normalize_names(name: str, spaces=False) -> str:
    ...
    Args:
        ...
        spaces (bool, optional): Indica si la cadena de caracteres incluye o no espacios. Defaults to False.
...
def only_letters(string: str, spaces=False) -> bool:
    ...
    Args:
        ...
        spaces (bool, optional): Define si la cadena de caracteres lleva o no espacios en blanco. Defaults to False.
